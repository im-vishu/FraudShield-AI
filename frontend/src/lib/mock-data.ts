...
export const CITIES: City[] = [
  { name: "Mumbai", tier: 1, lng: 72.8777, lat: 19.0760, riskPct: 12.4, txnCount: 48210 },
  ...
  { name: "Hyderabad", tier: 1, lng: 78.4867, lat: 17.3850, riskPct: 6.0, txnCount: 24500 },
...
export const ALERTS: Alert[] = [
  { id: "A-1", kind: "VELOCITY SPIKE", ts: "Just now", title: "Card ending in **4291", body: "12 transactions in 4 seconds.", severity: "critical" },
  { id: "A-2", kind: "GEO-ANOMALY", ts: "4m ago", title: "User Login from Mumbai", body: "Previously New York, 5 mins prior.", severity: "high", city: "Mumbai" },
  { id: "A-3", kind: "BOT PATTERN", ts: "12m ago", title: "Sequential bin probing", body: "Detected on Gateway ID: 941.", severity: "medium" },
  { id: "A-4", kind: "TIER SPIKE", ts: "21m ago", title: "Tier 3 fraud +312%", body: "Patna cluster — 87 attempts in 10 min.", severity: "critical", city: "Patna" },
  { id: "A-5", kind: "UPI ABUSE", ts: "38m ago", title: "Blacklisted UPI ID reuse", body: "ravi.fraud@oksbi attempted ₹48,000.", severity: "high" },
  { id: "A-6", kind: "GEO-ANOMALY", ts: "1h ago", title: "Impossible travel", body: "Delhi → Chennai in 8 minutes.", severity: "high" },
];
...
export const DEVICES: Device[] = [
  { id: "D-001", fingerprint: "fp_a91...c84", city: "Mumbai", ip: "192.168.1.45", os: "Android 14", lastSeen: "2m ago", risk: 89, txnCount: 142 },
  { id: "D-002", fingerprint: "fp_b22...e10", city: "Delhi", ip: "104.18.23.1", os: "iOS 17", lastSeen: "12m ago", risk: 12, txnCount: 88 },
  { id: "D-003", fingerprint: "fp_c77...a31", city: "Patna", ip: "157.2.44.90", os: "Android 13", lastSeen: "1h ago", risk: 76, txnCount: 24 },
  { id: "D-004", fingerprint: "fp_d44...b20", city: "Bangalore", ip: "12.55.234.12", os: "Web Chrome", lastSeen: "4m ago", risk: 18, txnCount: 311 },
  { id: "D-005", fingerprint: "fp_e88...f99", city: "Lucknow", ip: "65.21.12.4", os: "Android 12", lastSeen: "9m ago", risk: 64, txnCount: 41 },
];
...
export const REPORTS: Report[] = [
  { id: "REP-8821", title: "Weekly Fraud Summary", period: "Oct 17 – Oct 24, 2024", generatedAt: "Today, 09:14", flagged: 142, recovered: 4220000, scope: "All Tiers" },
  { id: "REP-8810", title: "Tier 3-4 Velocity Patterns", period: "Oct 1 – Oct 24, 2024", generatedAt: "Yesterday", flagged: 318, recovered: 1820000, scope: "Tier 3, 4" },
  { id: "REP-8801", title: "UPI Abuse Quarterly", period: "Q3 2024", generatedAt: "Oct 20", flagged: 1240, recovered: 18420000, scope: "UPI" },
  { id: "REP-8794", title: "Mumbai Cluster Report", period: "Oct 1 – Oct 15", generatedAt: "Oct 16", flagged: 92, recovered: 3110000, scope: "Mumbai" },
];
