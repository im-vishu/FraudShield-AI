    ...
    <div className="font-body text-on-surface bg-surface min-h-screen">
      <aside className="h-screen w-64 fixed left-0 top-0 bg-slate-100 dark:bg-slate-900 flex flex-col p-4 gap-y-2 z-50">
        <div className="mb-8 px-2 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-manrope font-extrabold text-slate-900 dark:text-slate-50 text-lg leading-tight">
              FraudShield AI
            </h1>
            <p className="text-[10px] uppercase tracking-[0.2em] text-on-secondary-container font-semibold">
        ...
        <nav className="flex-1 space-y-1">
          <a
            className="flex items-center gap-3 px-3 py-2.5 bg-slate-900 dark:bg-slate-50 text-white dark:text-slate-900 rounded-lg shadow-lg font-inter text-sm font-medium tracking-wide"
            href="/dashboard"
          >
          ...
          <a
            className="flex items-center gap-3 px-3 py-2.5 text-slate-600 dark:text-slate-400 hover:bg-slate-200/50 dark:hover:bg-slate-800/50 rounded-lg font-inter text-sm font-medium tracking-wide transition-all duration-150 ease-out"
        ...
        <div className="mt-auto pt-4 border-t border-slate-200 dark:border-slate-800 space-y-1">
          <a
            className="flex items-center gap-3 px-3 py-2.5 text-slate-600 dark:text-slate-400 hover:bg-slate-200/50 dark:hover:bg-slate-800/50 rounded-lg font-inter text-sm font-medium tracking-wide"
            href="#"
          >
          ...
          <a
            className="flex items-center gap-3 px-3 py-2.5 text-error hover:bg-error-container/20 rounded-lg font-inter text-sm font-medium tracking-wide"
            href="#"
          >
      ...
      <main className="ml-64 flex-1 flex flex-col min-h-screen relative">
        <header className="w-full sticky top-0 z-40 bg-slate-50/80 dark:bg-slate-950/80 backdrop-blur-xl flex justify-between items-center px-8 h-16 shadow-sm dark:shadow-none">
          <div className="flex items-center gap-4">
            <h2 className="font-manrope text-xl font-bold tracking-tight text-slate-900 dark:text-slate-50">
              Global System Administration
            </h2>
          </div>
          <div className="flex items-center gap-6">
            <div className="flex items-center bg-surface-container rounded-lg px-3 py-1.5 gap-2">
              <span className="material-symbols-outlined text-outline text-sm" data-icon="search">
                search
              </span>
              <input
                className="bg-transparent border-none focus:ring-0 text-sm font-inter w-64 p-0"
            ...
            <div className="flex items-center gap-2">
              ...
              <button className="w-10 h-10 rounded-lg flex items-center justify-center hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
                <span className="material-symbols-outlined text-slate-600" data-icon="settings">
                  settings
                </span>
              </button>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-surface-container-low rounded-xl p-6 relative overflow-hidden group">
              <div className="relative z-10">
                <p className="text-xs font-semibold text-on-secondary-container uppercase tracking-widest mb-2">
                  Total Active Users
                </p>
              ...
              <div className="absolute -right-4 -bottom-4 opacity-5 group-hover:opacity-10 transition-opacity">
                <span className="material-symbols-outlined text-8xl" data-icon="group">
                  group
                </span>
              </div>
            </div>
            ...
            <div className="bg-surface-container-low rounded-xl p-6 relative overflow-hidden group">
              <div className="relative z-10">
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-emerald-100 text-emerald-700 uppercase tracking-tighter">
                    Operational
                  </span>
                </div>
              ...
              <div className="absolute -right-4 -bottom-4 opacity-5 group-hover:opacity-10 transition-opacity">
                <span className="material-symbols-outlined text-8xl" data-icon="dns">
                  dns
                </span>
              </div>
            </div>
            ...
            <div className="bg-surface-container-low rounded-xl p-6 relative overflow-hidden group">
              <div className="relative z-10">
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-error-container text-on-error-container uppercase tracking-tighter">
                    High Priority
                  </span>
                </div>
              ...
              <div className="absolute -right-4 -bottom-4 opacity-5 group-hover:opacity-10 transition-opacity">
                <span className="material-symbols-outlined text-8xl" data-icon="emergency_home">
                  emergency_home
                </span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-12 gap-6">
            <div className="col-span-12 lg:col-span-8 bg-surface-container-lowest rounded-xl p-0 overflow-hidden shadow-sm border border-outline-variant/10">
              <div className="p-6 flex justify-between items-center bg-surface-container-low/50">
                <div>
                  <h4 className="font-manrope font-bold text-lg text-slate-900">
                    User Management Registry
                  </h4>
                  <p className="text-sm text-outline">
                    Manage administrative and analyst access levels
                  </p>
                </div>
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-outline-variant/10">
                  ...
                  <tr className="hover:bg-slate-50/50 transition-colors">
                    <td className="px-6 py-4 flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-tertiary-fixed flex items-center justify-center text-[10px] font-bold text-on-tertiary-fixed">
                        MR
                      </div>
            ...
            <div className="col-span-12 lg:col-span-4 flex flex-col gap-6">
              <div className="bg-surface-container-low rounded-xl p-6 flex-1 shadow-sm border border-outline-variant/10">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <span className="material-symbols-outlined text-slate-400" data-icon="refresh">
                    refresh
                  </span>
                </div>
                <div className="space-y-6 relative before:absolute before:left-[11px] before:top-2 before:bottom-2 before:w-0.5 before:bg-slate-200">
                  <div className="relative pl-8">
                    ...
                    <p className="text-xs text-slate-500">
                      User <span className="font-bold text-slate-700">Admin_JD</span> changed core
                      sensitivity from 0.75 to 0.82
                    </p>
                    <p className="text-[10px] text-outline mt-1 font-bold uppercase tracking-tighter">
                      12 minutes ago
                    </p>
                  </div>
                  ...
                  <div className="relative pl-8">
                    ...
                    <p className="text-xs text-slate-500">
                      Auto-recovery completed for{" "}
                      <span className="font-bold text-slate-700">Node_EU_West</span> after latency
                      spike
                    </p>
                    <p className="text-[10px] text-outline mt-1 font-bold uppercase tracking-tighter">
                      45 minutes ago
                  ...
                  <div className="relative pl-8">
                    ...
                    <p className="text-xs text-slate-500">
                      Admin account <span className="font-bold text-slate-700">Marcus Rossi</span>{" "}
              ...
              <div className="relative z-10 p-8 flex flex-col h-full justify-between">
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h4 className="font-manrope font-bold text-xl text-white">
                      Live Global Attack Vectors
                    </h4>
                  </div>
                  <p className="text-slate-400 text-sm max-w-md">
                    Real-time monitoring of adversarial AI and brute-force attempts targeting
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="bg-black/30 backdrop-blur-md p-4 rounded-lg border border-white/10">
                    ...
                    <p className="text-lg font-bold text-white mt-1">
                      1,204 <span className="text-[10px] text-emerald-400">Stable</span>
                    </p>
                  </div>
                  <div className="bg-black/30 backdrop-blur-md p-4 rounded-lg border border-white/10">
                    <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold">
                    ...
                    <p className="text-lg font-bold text-white mt-1">
                      4,891 <span className="text-[10px] text-error">Elevated</span>
                    </p>
                  </div>
                  <div className="bg-black/30 backdrop-blur-md p-4 rounded-lg border border-white/10">
                    <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold">
                    ...
                    <p className="text-lg font-bold text-white mt-1">
                      842 <span className="text-[10px] text-emerald-400">Stable</span>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="col-span-12 lg:col-span-5 bg-surface-container-lowest rounded-xl p-8 shadow-sm border border-outline-variant/10 flex flex-col justify-between">
              <div>
                <h4 className="font-manrope font-bold text-lg text-slate-900 mb-2">
                  Infrastructure Performance
                </h4>
                <p className="text-sm text-outline mb-6">
                  Network latency &amp; system load across primary clusters
                </p>
        ...
        <footer className="mt-auto p-8 bg-slate-100/50 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-6">
            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.3em]">
              FraudShield Sentinel Core v4.2.0
            </span>
