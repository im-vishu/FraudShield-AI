...
<div className="p-6">
<h1 className="text-xl font-bold tracking-tighter text-slate-900 dark:text-white font-manrope">Sovereign Sentinel</h1>
<p className="text-[10px] uppercase tracking-widest text-slate-500 mt-1 font-semibold">Fraud Prevention AI</p>
</div>
<nav className="flex-1 px-4 space-y-1">
<a className="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors duration-200 text-slate-500 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-800/80 group" href="/dashboard">
...
<a className="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors duration-200 text-slate-500 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-800/80 group" href="/dashboard/transactions">
...
<a className="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors duration-200 text-slate-500 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-800/80 group" href="/dashboard/alerts">
...
<a className="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors duration-200 bg-slate-200/50 dark:bg-slate-800 text-slate-900 dark:text-white font-semibold group scale-100 active:scale-95 transition-transform" href="/dashboard/risk-analysis">
...
<a className="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors duration-200 text-slate-500 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-800/80 group" href="#">
<span className="material-symbols-outlined text-[20px]" data-icon="devices">devices</span>
<span className="font-manrope text-sm font-medium tracking-tight">Devices</span>
</a>
<a className="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors duration-200 text-slate-500 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-800/80 group" href="/dashboard/admin">
...
<div className="w-8 h-8 rounded-lg bg-primary flex items-center justify-center text-white text-xs font-bold">CSO</div>
...
<span className="material-symbols-outlined text-slate-500 text-[20px]" data-icon="search">search</span>
<input className="bg-transparent border-none focus:ring-0 text-sm font-manrope w-full ml-2" placeholder="Search Risk Patterns..." type="text" />
</div>
...
<span className="text-sm font-medium text-slate-500 hover:text-slate-900 cursor-pointer transition-all">Support</span>
...
<div>
<h2 className="text-4xl font-light font-manrope tracking-tight text-on-surface">Risk <span className="font-extrabold">Intelligence</span></h2>
<p className="text-on-surface-variant mt-2 font-medium">Advanced pattern recognition and behavioral risk mapping</p>
</div>
...
<span className="text-[10px] font-bold tracking-widest text-on-surface-variant uppercase">Spatial Visualization</span>
...
<img className="w-full h-full object-cover opacity-80 mix-blend-multiply" data-alt="abstract satellite topographic map of india with glowing red and orange heatmap overlays on major metropolitan hubs dark cinematic lighting" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBC7nEzy34g10tbaA_wDz6dnI1bZfcja2YhZaBZ1T3MLEfoG2ul9y2cvYQvudFnhQ37Yj1ixQqBhWzVt9xgDQXKag7kHsR5JCAqfeRcwH2RzC-ckQ_Oclip6qzJtZt00xoIzosLBH5cN24p4n4MKu5TSmg6yhyOp-la1UsUovOCCKvl3bWzPaYbVmXksdkD_w4zc8nwf93gCflunGLf-NiDMpIyZNdrBrKe5xXxoDl_EU_FR4WDhvSRp7CNqX-yzZLLSNc36HwkyvmO" />
...
<span className="material-symbols-outlined text-secondary-fixed" data-icon="model_training">model_training</span>
<span className="text-xs font-bold uppercase tracking-widest text-on-primary-container">Threshold Simulator</span>
</div>
<h3 className="text-2xl font-manrope font-bold mb-2">Policy Calibration</h3>
<p className="text-on-primary-container text-sm leading-relaxed">Adjust AI sensitivity to balance friction vs. security. Current projected false positive rate: <span className="text-white font-bold">0.82%</span></p>
...
<div>
<h3 className="text-lg font-manrope font-extrabold tracking-tight">Temporal Patterns</h3>
<p className="text-xs text-on-surface-variant font-medium">Hourly fraud distribution (24hr cycle)</p>
</div>
...
<h3 className="text-lg font-manrope font-extrabold tracking-tight mb-6">High-Risk Entities</h3>
<div className="space-y-4">
...
<p className="text-[11px] text-on-surface-variant">Merchant Terminal • Mumbai</p>
</div>
</div>
<div className="text-right">
<p className="text-sm font-black text-error">98.2</p>
<p className="text-[10px] uppercase font-bold tracking-tighter opacity-50">Score</p>
</div>
</div>
...
<span className="material-symbols-outlined text-[20px]" data-icon="smartphone">smartphone</span>
</div>
<div>
...
<p className="text-[11px] text-on-surface-variant">Consumer • Bengaluru</p>
</div>
</div>
<div className="text-right">
...
<p className="text-xs text-on-surface-variant leading-relaxed">Detected 12% increase in 'Account Takeover' signatures across South-East corridors in the last 4 hours.</p>
</div>
<div className="p-6 bg-surface-container-low border border-outline-variant/10 rounded-xl">
<span className="material-symbols-outlined text-primary mb-4" data-icon="hub">hub</span>
<h4 className="font-manrope font-bold text-sm mb-2">Network Affinity</h4>
<p className="text-xs text-on-surface-variant leading-relaxed">3 High-risk nodes identified as belonging to the same hardware cluster. Isolation recommended.</p>
</div>
<div className="p-6 bg-surface-container-low border border-outline-variant/10 rounded-xl">
...
<p className="text-xs text-on-surface-variant leading-relaxed">Increasing threshold by 4% would reduce false positives by 18% with negligible impact on catch rate.</p>
</div>
</div>
</div>
</main>
